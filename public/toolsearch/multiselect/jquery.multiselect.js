...
(function($){
    var defaults = {
        ...
        texts: {
            ...
            selectAllTxt   : 'Select all',     // select all text
            unselectAllTxt : 'Unselect all',   // unselect all text
    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            if( instance.options.selectAll ) {
                optionsList.before('<a href="#" class="ms-selectall global">' + instance.options.texts.selectAllTxt + '</a>');
            }
            ...
            optionsWrap.on('click', '.ms-selectall', function( event ){
                ...
                if( $(this).hasClass('global') ) {
                    ...
                    optgroup.find('li.selected input[type="checkbox"]').each(function(){
                        vals.push( $(this).val() );
                    });
                }
            ...
            for( var key in options ) {
                ...
                // OPTGROUP
                    ...
                    if( appendContainer ) {
                        ...
                        //    container.append('<a href="#" class="ms-selectall">' + instance.options.texts.selectAllTxt + '</a>');
                        //}
                        if( instance.options.selectGroup ) {
                            container.append('<label><input type="checkbox" class="ms-selectall">' + instance.options.texts.selectAllTxt + '</label>');
                        }
        ...
        _updateSelectAllText: function(){
            ...
            // update un/select all checkbox
            optionsWrap.find('.ms-selectall').each(function(){
                var optgroup = $(this).closest('li.optgroup');
                var unselected = optgroup.find('li:not(.selected,.ms-hidden)');
        ...
        _updatePlaceholderText: function(){
            ...
            //instance.options.texts.placeholder  //the object which holds the original name
            if(selectVals.length>0) {
              placeholderTxt.text( instance.options.texts.placeholder + ' (' + selectVals.length + ')')
            }else{
            ...
            //    placeholderTxt.text("whatever text 2");
            //}
        },
